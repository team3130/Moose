...
public class RobotContainer {
    ...
    HoodPnuematics hoodPnumatics = new HoodPnuematics();
    ...
    public HoodPnuematics getHood() {return hoodPnumatics;}
    ...
    public void defineButtonBindings(SendableChooser<String> m_chooser_driver, SendableChooser<String> m_chooser_weapons) {
        ...
        if (m_chooser_weapons.getSelected().equals("Ben")) {
           ...
           new JoystickButton(m_weaponsGamepad, RobotMap.LST_BTN_RBUMPER).whenHeld(new ParallelDeadlineGroup(new TimedFaceTarget(m_chassis, m_limelight), new Shoot(m_shooter, hoodPnumatics, m_limelight)));
